...
public class _01_ScreenShot extends BaseDriver {
    ...
    public void screenShot() throws IOException {
        ...
        if (errorMessage.isDisplayed()) {
            ...
            FileUtils.copyFile(screenShotInTheMemory, new File("screenShots/screenShot" + localDateTime.format(myFormat) + ".png")); // Stores the screenshot as a file in the permanent memory
        }
